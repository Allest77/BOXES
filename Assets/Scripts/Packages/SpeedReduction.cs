...
public class SpeedReduction : MonoBehaviour {
    ...
    float minAmount, envelopeAmount, plasticAmount, sBoxAmount, mBoxAmount, lBoxAmount, customAmount;
    ...
    void SpeedReduction() {
        ...
        customAmount = Random.Range(packagePrefabs[minAmount], packagePrefabs[envelopeAmount], packagePrefabs[plasticAmount], packagePrefabs[sBoxAmount], packagePrefabs[mBoxAmount], packagePrefabs[lBoxAmount], packagePrefabs[maxAmount]);
    } 
